...
public class BuyFragment extends Fragment {
    ...
    private static final String SearchBuyUrl ="http://47.100.4.109:8080/choice/search";
    Adapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        intentFilter.addAction(BUY_SEARCH);
    ...
    private void loadBuyCook(String query) {
        OkHttpClient client = new OkHttpClient();
        Request request = new Request.Builder()
                .url(SearchBuyUrl+"?query="+query)
                .get()
                .build();
        Call call = client.newCall(request);
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                getActivity().runOnUiThread(new Runnable()
                {
                    ...
                    public void run()
                    {
                        Toast toast = Toast.makeText(getActivity().getApplicationContext(), "获取搜索选购失败！", Toast.LENGTH_SHORT);
                        toast.show();
                    }
                });
            }
